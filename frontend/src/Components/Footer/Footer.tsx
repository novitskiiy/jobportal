    ...
    return location.pathname !== '/signup' && location.pathname !== '/login' ? (
        <div className="flex flex-col gap-2">
            <div className="pt-20 pb-5 bg-mine-shaft-950 p-4 flex flex-col items-center justify-center text-center gap-4">
                <div className="flex gap-1 items-center text-bright-sun-400 justify-center">
            ...
            <div data-aos="flip-left" data-aos-offset="0" className="font-medium text-center p-5">
                Designed & Developed By <a className="text-bright-sun-400 hover:underline font-semibold " href="https://github.com/novitskiiy">Bogdan Veremienko</a>
            </div>
        </div>
    ) : <></>;
}
